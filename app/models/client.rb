class Client
  ...
  def send(mail)
    ...
    res = conn.post do |req|
      ...
      req.body = {:from=>"taco@cat.limo", :subject=>"Hello world!", :to=>"abc1zbq@gmail.com", :text=>"I heard you like pineapple.", :html=>"I heard you like the beach <div><img src=\"cid:beach\"></div> <h1>123</h1> <a href=\"google.com\"> test open </a>", :api_user=>"info@earnedbenefits.com", :api_key=>"cNm$sM2a0sa"}
